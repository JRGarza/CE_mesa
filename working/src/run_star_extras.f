...
! ***********************************************************************
 ...
 ! copied the content from star/job/standard_run_satr_extras.inc here and made the necessary changes
      ...
      use CE_adjust_mdot
      use CE_timestep
      use eos_lib, only: eosDT_get_9575, eosDT_get_T
      ...
      subroutine my_other_eosDT_get( &
         ...
         call eosDT_get_9575(&
               ...
               species, chem_id, net_iso, xa, &
               Rho, log10Rho, T, log10T, s% eos_partials_consistency_level, &
               res, d_dlnRho_const_T, d_dlnT_const_Rho, &
               d_dabar_const_TRho, d_dzbar_const_TRho, ierr)


      end subroutine my_other_eosDT_get


      subroutine my_other_eosDT_get_T( &
               id, k, handle, Z, X, abar, zbar, &
               species, chem_id, net_iso, xa, &
      ...
      end subroutine my_other_eosDT_get_T
      ...
      subroutine extras_controls(id, ierr)
         ...
         s% other_eosDT_get => my_other_eosDT_get
         s% other_eosDT_get_T => my_other_eosDT_get_T
         ...
         s% xtra21 = 1.
         !s% xtra22 -> mdot_HL. Hoyle-Littleton accretion rate onto compact object. Calculated in CE_energy_rate
         s% xtra22 = 0.0d0
         !s% xtra23 -> mdot_macleod. Macleod & Ramirez-Ruiz accretion rate onto compact object. Calculated in CE_energy_rate
         s% xtra23 = 0.0d0
